...
export const Introduction = () => {
  ...
  return (
    ...
    <h4>
        ...
        <span className="different">Computer Science major and Math Double Major</span> with a strong drive in bridging coding and numbers for community development.
    </h4>
